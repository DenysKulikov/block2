...
public interface EmployeeRepository {
    Employee create(@Param("employee") Employee employee, @Param("companyId") Long companyId, @Param("salaryId") Long salaryId, @Param("position") Position position) throws SQLException;
